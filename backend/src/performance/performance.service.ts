...
export class PerformanceService {
  ...
  async createReview(dto: CreateReviewDto) {
    ...
    return this.prisma.performanceReview.create({ data: { employeeId: dto.employeeId, reviewerId: dto.reviewerId, reviewPeriodStart: new Date(dto.reviewPeriodStart), reviewPeriodEnd: new Date(dto.reviewPeriodEnd), ratings: {}, feedback: dto.feedback ?? '', score: dto.score ?? 0 } as any });
  }
